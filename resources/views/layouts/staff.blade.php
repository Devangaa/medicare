...
<head>
    ...
    <title>@yield('title', 'Staff Dashboard') — Medicare</title>
    <!-- Tailwind CSS CDN -->
    ...
    <aside id="sidebar"
        ...
        <div class="space-y-8 flex-1 overflow-y-auto pr-1">
            ...
            <nav class="space-y-1.5">
                ...
                <!-- Dashboard -->
                <a href="{{ url('/staff/dashboard') }}" class="menu-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ Request::is('staff/dashboard*') ? 'bg-slate-800 text-white border border-slate-700 shadow-lg' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}" data-icon="fa-chart-pie" data-label="Dashboard">
                    <i class="fa-solid fa-chart-pie w-5 shrink-0"></i>
                    <span class="sidebar-text">Dashboard</span>
                </a>

                <!-- Data Obat -->
                <a href="{{ url('/staff/obat') }}" class="menu-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ Request::is('staff/obat*') ? 'bg-slate-800 text-white border border-slate-700 shadow-lg' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}" data-icon="fa-pills" data-label="Data Obat">
                    <i class="fa-solid fa-pills w-5 shrink-0"></i>
                    <span class="sidebar-text">Data Obat</span>
                </a>

                <!-- Transaksi -->
                <a href="{{ url('/staff/transaksi') }}" class="menu-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ Request::is('staff/transaksi*') ? 'bg-slate-800 text-white border border-slate-700 shadow-lg' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}" data-icon="fa-wallet" data-label="Transaksi">
                    <i class="fa-solid fa-wallet w-5 shrink-0"></i>
                    <span class="sidebar-text">Transaksi</span>
                </a>

                <!-- Pembelian Obat -->
                <a href="{{ url('/staff/pembelian-obat') }}" class="menu-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ Request::is('staff/pembelian*') ? 'bg-slate-800 text-white border border-slate-700 shadow-lg' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}" data-icon="fa-cart-shopping" data-label="Pembelian Obat">
                    <i class="fa-solid fa-cart-shopping w-5 shrink-0"></i>
                    <span class="sidebar-text">Pembelian Obat</span>
                </a>

                <!-- Pembuangan Obat -->
                <a href="{{ url('/staff/pembuangan-obat') }}" class="menu-item flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all {{ Request::is('staff/pembuangan*') ? 'bg-slate-800 text-white border border-slate-700 shadow-lg' : 'text-slate-400 hover:bg-slate-800/50 hover:text-slate-200' }}" data-icon="fa-trash-can" data-label="Pembuangan Obat">

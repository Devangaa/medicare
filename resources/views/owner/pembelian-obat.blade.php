...
<div class="space-y-6">
    ...
    <div class="bg-[#0f172a] border border-slate-800 rounded-2xl p-6">
        ...
        <p class="text-sm text-slate-400 mt-1">
            Persetujuan penambahan stok obat dari staff.
        </p>
...
<script>
    ...
    function openApproveModal(id)
    {
        ...
        form.action =
            `/owner/pembelian-obat/${id}/approve`;
    ...
    function openRejectModal(id)
    {
        ...
        form.action =
            `/owner/pembelian-obat/${id}/reject`;
...
@include('owner.modals.pembelian-approve')
@include('owner.modals.pembelian-reject')
